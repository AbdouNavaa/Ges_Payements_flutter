                                            ...
                                            children: [
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(snapshot.data![i]['nom'],style: TextStyle(fontWeight: FontWeight.bold,fontStyle: FontStyle.italic,fontSize: 25,
                                            ...
                                            Container(margin:EdgeInsets.only(right: 5,top: 5),height: 55,
                                              child: ElevatedButton(
                                                ...
                                                children: [
                                                  ...
                                                  Text("Back", style: TextStyle(color: Colors.blue[900]),),
                                                ],
                                              ),
                                            ...
                                            Container(margin:EdgeInsets.only(left: 15,top: 5),height: 55,
                                              child: ElevatedButton(
                                                  ...
                                                  child: Row(
                                                    mainAxisAlignment:MainAxisAlignment.spaceBetween,
                                                    children: [
                                                      Text('Courses',style: TextStyle(color: Colors.blue[900]), ),
