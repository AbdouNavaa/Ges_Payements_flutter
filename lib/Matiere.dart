...
import 'package:gest_payement/Types.dart';
            ...
            child: Column(
              ...
              children: [
               // CircleAvatar(child: Drawer(child: Icon(Icons.list),),backgroundColor: Colors.white,radius: 30.0,),
                Row(
                  children: [
                    Icon(Icons.collections_bookmark_outlined,size: 35,), SizedBox(width: 10,),
                    Text('List de Matieres',style: TextStyle(fontSize: 25.0,fontWeight: FontWeight.w900,fontStyle: FontStyle.italic),),
                  ],
                ),
                SizedBox(height: 8.0),
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(onPressed: (){
                      ...
                      children: [
                        Text("Types",style: TextStyle(fontSize: 20,color: Colors.blue),),
                        Icon(Icons.arrow_forward_ios,size: 23,color: Colors.blue,),
                      ],
                              ...
                              Row(
                                ...
                                children: [
                                  ElevatedButton(
                                    ...
                                    child: Text('Delete',style: TextStyle(fontSize: 18,color: Colors.red, fontStyle: FontStyle.italic),),
